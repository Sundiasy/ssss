...
SkillType NaoBehavior::selectSkill() {
 ...
 if(worldModel ->getUNum() == WO_TEAMMATE2)
    {
        if(me.getDistanceTo(VecPosition(3,4,0))>1&&me.getDistanceTo(ball)>1)
        {
            return goToTarget(VecPosition(3,4,0));
        }
    
        else if(me.getDistanceTo(VecPosition(3,4,0))<1)
        {
    ...
    {
        if(me.getDistanceTo(VecPosition(0,0))<1&&me.getDistanceTo(ball)<1)
        {
            return kickBall(KICK_IK,VecPosition(3,3,0));
        }else if (me.getDistanceTo(VecPosition(0,0))>1)
        {
             return goToTarget(VecPosition(0,0,0));
        }else if(me.getDistanceTo(VecPosition(0,0))<1&&me.getDistanceTo(ball)>1)
        {
            return SKILL_STAND;
    ...
    //   if (worldModel->getUNum() == WO_TEAMMATE1)
    // {
    //     if(me.getDistanceTo(VecPosition(0,0))<1&&me.getDistanceTo(ball)>2)
    //     {
    //         return SKILL_STAND;
    ...
    // if(worldModel ->getUNumSet() == WO_TEAMMATE2)
    // {
    //     return goToTarget(VecPosition(3,4,0));
